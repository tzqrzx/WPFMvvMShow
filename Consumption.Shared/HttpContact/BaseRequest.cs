            ...
            if (propertyArray != null && propertyArray.Length > 0)
            {
                foreach (PropertyInfo property in propertyArray)
                {
                        ...
                        )
                    {
                        ...
                        //pvalue = JsonConvert.SerializeObject(pvalue, Formatting.Indented, jsonSetting);
                        pvalue = JsonConvert.DeserializeObject(JsonConvert.SerializeObject(pvalue));
